...
function refreshList(liste, articles) {
	...
	console.log(articles)
	  ...
	  document.querySelector('.Article__list').innerHTML = `<li>${article.art_titre}</li>`;
...
// <a href="javascript:ajout()">Ajouter</a>
			...
			// 			<img src="img/blog5_mini.jpg" alt="aircraft design"/>
			// 		</figure>
			...
			// 			<a class="Article__button Button" href="article.html" alt="Lire l'article">Lire l'article &#8594;</a>
			// 			<ul class="Article__partage">
			// 				<li class="Partage__item Partage__item--facebook"><!--Facebook icone-->
			// 					<a href="#" class="Partage__link" alt="Partager sur Facebook">
    ...
    if (req.readyState === 4){
    	if (req.status === 200){
    		...
    		console.log('articles');
				...
				// let barredefiltre = document.getElementById("filter");
				// barredefiltre.addEventListener("keydown", function filterStudents(){console.log(barredefiltre.value)});
